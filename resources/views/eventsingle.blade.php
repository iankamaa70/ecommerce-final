  ...
  <main id="main_content" itemprop="mainContentOfPage" tabindex="-1">
	...
	<div class="container hero-basic__container">
		<div class="hero-basic__inner">
					...
					<a href="{{ route('event') }}">Events / <time class="post__published" datetime="2019-07-23T19:26:57+00:00">{{ $event->event_date }}</time></a>				</p>
										<h1 class="main-title hero-basic__title">{{ $event->name }}</h1>
...
<img class="image__img" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-normal="{{ asset($event->image) }}" data-retina="{{ asset($event->image) }}"></figure>
			</section>
	...
	<div class="container post-footer__container">
		<div class="post-footer__inner">
			<div class="post-footer__inner-content">
						...
						<a href="{{ route('event') }}" class="label-text">< Back to News</a>
					</div>
